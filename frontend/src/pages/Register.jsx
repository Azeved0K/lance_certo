        ...
        <div className={styles.authContainer}>
            <div className={styles.authCard}>
                ...
                <div className={styles.authHeader}>
                    <div className={styles.authLogo} style={{ background: 'linear-gradient(135deg, var(--secondary-color), #059669)' }}>
                    ...
                    <p className={styles.authSubtitle}>Junte-se a nós e comece a capturar momentos!</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className={styles.authForm}>
                    ...
                    <div className={styles.checkbox} style={{ marginBottom: '1.5rem' }}>
                ...
                <p className={styles.authFooter}>
                    Já tem uma conta? <Link to="/login" className={styles.authLink}>Faça login</Link>
                </p>
            </div>
        </div>
    );
